      ...
      <div className="menu">
        ...
        <div className="how-to">
          ...
          <ul>
            ...
            <li>Slain beasts drop <b>XP gems</b> that fly to you — grab them to <b>level up</b></li>
            <li>Every level you <b>choose a skill</b>: a new auto-weapon or an upgrade — spirit blades, wand, frost aura, axes, lightning</li>
            <li>Enemies get <b>tougher and more numerous each level</b>, and a <b>big boss appears every 5 levels</b></li>
            <li>Tap <b>⏸</b> (or press <b>P / Esc</b>) to pause anytime</li>
